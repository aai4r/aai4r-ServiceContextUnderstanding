...
class CloudTableThingsFineClass(imdb):
    def __init__(self, image_set, devkit_path=None):
        imdb.__init__(self, 'CloudTableThingsFineClass_' + image_set)
        self._year = 2007
        self._image_set = image_set
        self._devkit_path = cfg_d.CloudTableThingsFineClass
    ...
    def _load_pascal_annotation(self, index):
        ...
        for ix, obj in enumerate(objs):
            ...
            try:
                obj_name = obj.find('name').text.strip()
                if obj_name in self._dish_classes:
