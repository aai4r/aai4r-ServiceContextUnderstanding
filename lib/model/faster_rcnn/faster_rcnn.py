...
class _fasterRCNN(nn.Module):
    """ faster RCNN """
    def __init__(self, classes, class_agnostic, use_share_regress=False, use_progress=False):
    ...
    def forward(self, im_data, im_info, gt_boxes, num_boxes, gt_progress=-1, use_gt_bbox_in_rpn=False, al_mode=False):
        ...
        if self.training:
            ...
            if use_gt_bbox_in_rpn:
                # replace rois to gt_bboxes
                # gt_boxes.shape [1, 30, 6]
                # rois.shape [1, 300, 5]
        ...
        # check rois is ratio? center-based?
        # rois ex: [0.0, 430.5, 314.9, 696.3, 513.4]
        # shape: [1, 300, 5]
